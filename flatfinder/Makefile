...
SOURCES = \
	__init__.py \
	FlatFinder.py FlatFinder_dialog.py

PLUGINNAME = FlatFinder

PY_FILES = \
	__init__.py \
	FlatFinder.py FlatFinder_dialog.py

UI_FILES = FlatFinder_dialog_base.ui
...
QGISDIR=C:\Users\seise\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
